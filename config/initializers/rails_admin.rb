# RailsAdmin config file. Generated on January 11, 2013 10:46
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Serv Ing', 'Admin']
  ...
  # config.excluded_models = ['Message', 'Picture', 'Property']

  # Include specific models (exclude the others):
  # config.included_models = ['Message', 'Picture', 'Property']
  ...
  #     configure :rooms, :float 
  #     configure :string, :string 
  #     configure :bathrooms, :float 
  #     configure :mts, :float 
  ...
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :parkingspace, :integer 
